"""
Django settings for anphytest project.
...
WSGI_APPLICATION = 'anphytest.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'anphytest_db'),
