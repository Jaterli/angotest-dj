    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-2">
      ...
      <div class="flex items-center gap-2">
        <div class="flex items-center">
          <img src="assets/Logo-AngoTest_footer.png" alt="Logo AnGoTest" class="h-8 w-auto mr-2">
          <span class="text-sm sm:text-lg font-semibold text-gray-900 dark:text-gray-100">AngoTest</span>
        </div>
        <span class="text-gray-400 dark:text-gray-500 text-sm sm:text-lg">•</span>
        <span class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">© {{currentYear}} Todos los derechos reservados</span>
      </div>
